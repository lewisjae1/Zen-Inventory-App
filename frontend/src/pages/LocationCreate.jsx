import { fetchUserRoleData } from '../utils/dataFetchutils'
...
function LocationCreate() {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const res = await api.post('api/location/create/', locationData)
        setCompleted(true)
      } catch(error) {
        console.log(error)
        if (navigator.onLine){
    ...
    if(Completed) {
      return <div className='orderCreateDiv'>
        <div className="success">
          ...
          {navigator.onLine && <div className="success__title">성공적으로 생성하셨습니다!<br/>Successfully Created!</div>}
    ...
    return <div className='orderCreateDiv'>
        <div className='login-box'>
            <form onSubmit={handleSubmit}>
                <h1>Location Create<br/>지점 생성</h1>
